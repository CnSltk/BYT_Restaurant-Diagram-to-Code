...
public class AssociationTests
{
     [TestFixture]
        public class ManagerStaffAssociationTests
        {
            ...
            {
                var senior = Staff.CreateManager(1, "Derya", "Ogus", 80000, "IT", Level.Senior);
                var junior = Staff.CreateManager(2, "İbrahim", "Yeşil", 50000, "IT", Level.Junior);
            ...
            {
                var manager = Staff.CreateManager(1, "Derya", "Ogus", 80000, "IT", Level.Senior);
                var staff = Staff.CreateManager(2, "İbrahim", "Yeşil", 50000, "IT", Level.Junior);
            ...
            {
                var junior = Staff.CreateManager(1, "İbrahim", "Yeşil", 50000, "IT", Level.Junior);
                var senior = Staff.CreateManager(2, "Derya", "Ogus", 80000, "IT", Level.Senior);
            ...
            {
                var manager1 = Staff.CreateManager(1, "Derya", "Ogus", 80000, "IT", Level.Senior);
                var manager2 = Staff.CreateManager(2, "Arda", "Seydol", 85000, "IT", Level.Senior);
                var staff = Staff.CreateManager(3, "İbrahim", "Yeşil", 50000, "IT", Level.Junior);
        ...
        public class ShiftAssociationBagTests
        {
            ...
            public void Bag_AllowsMultipleShiftAssociations_SameRestaurantAndStaff()
            {
                ...
                var staff = Staff.CreateManager(1, "Alice", "Smith", 70000, "Kitchen", Level.Senior);
            ...
            {
                var restaurant = new Restaurant(1, "Bella Vista", "11:00-22:00");
                var staff = Staff.CreateManager(1, "Derya", "Ogus", 60000, "Service", Level.Junior);
            ...
            {
                var restaurant = new Restaurant(1, "Bella Vista", "11:00-22:00");
                var staff = Staff.CreateManager(1, "Arda", "Seydol", 55000, "HR", Level.Junior);
                var shift = ShiftAssociation.Create(staff, restaurant, ShiftType.Morning);
            ...
            {
                var restaurant = new Restaurant(1, "Bella Vista", "11:00-22:00");
                var staff1 = Staff.CreateManager(1, "Charlie", "Kirk", 70000, "Kitchen", Level.Mid);
                var staff2 = Staff.CreateManager(2, "Elon", "Musk", 65000, "Kitchen", Level.Junior);
        ...
        public class MultipleAssociationsIntegrationTests
        {
            ...
            public void ComplexScenario_AllAssociationsWorkTogether()
            {
                ...
                var staff1 = Staff.CreateManager(2, "Bob", "Jones", 50000, "Kitchen", Level.Junior);
                var staff2 = Staff.CreateManager(3, "Charlie", "Brown", 55000, "Service", Level.Junior);
        ...
        public class RestaurantTableCompositionTests
        {
            ...
            public void RemoveTable_BreaksConnection()
            {
                ...
                // Table extent check depends on your Table class implementation
            }
            ...
            public void DeleteRestaurant_CascadesDeleteTables()
            {
                ...
                Assert.That(restaurant.Tables.Count, Is.EqualTo(2)); // Tables still exist but restaurant is marked deleted
                // Extent checks depend on your Restaurant class implementation
            }
...
public class MenuItemsTests
{
    ...
    public void AddQuantity_DifferentMenuItem_Throws()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => item2.AddQuantityInternal(q));
    }
    ...
    public void AddQuantity_Duplicate_Throws()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => item.AddQuantityInternal(q));
    }
}
    ...
    public class TestMenuItem
    {
        ...
        public IReadOnlyList<Ingredient> Ingredients => Item.Ingredients;
        public IReadOnlyList<Menu.Menu> Menus => Item.Menus;

        public void AddIngredient(Ingredient ing) => Item.AddIngredient(ing);
        public void AddMenu(Menu.Menu menu) => Item.AddMenu(menu);
    }
