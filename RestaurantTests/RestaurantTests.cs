...
public class EmployeeStaffTests
{
    ...
    {
        public TestableStaff(int staffId, string firstName, string lastName, decimal salary, string department, StaffType staffType)
    ...
    {
        var staff = new TestableStaff(1,"Derya", "Ogus", 50000, "IT", StaffType.Chef);
    ...
    public void Constructor_NullFirstName_Throws()
    {
        var ex = Assert.Throws<ArgumentException>(() =>
            new TestableStaff(1,null, "Ogus", 50000, "IT", StaffType.Chef)
        );
    ...
    {
        var ex = Assert.Throws<ArgumentException>(() =>
            new TestableStaff(1,"", "Ogus", 50000, "IT", StaffType.Chef)
        );
...
public class ChefTests
{
    ...
    public void Setup()
    {
        var extentField = typeof(Staff).GetField("_chefExtent");
    ...
    {
        Assert.Throws<ArgumentException>(() => new Staff(1,"", "Ramsay", 5000m, "Kitchen", StaffType.Chef));
    }

    [Test]
    public void SaveAndLoad()
    {
        new Staff(2,"Marco", "Pierre", 5500m, "Kitchen", StaffType.Chef);
    ...
    {
        var chef = new Staff(3,"Gordon", "Ramsay", 5000m, "Kitchen", StaffType.Chef);
    ...
    {
        var chef = new Staff(4,"Gordon", "Ramsay", 5000m, "Kitchen", StaffType.Chef);
...
public class HeadChefTests
{
    ...
    public void Setup()
    {
        var chefExtentField = typeof(Staff).GetField("_chefExtent");
        chefExtentField?.SetValue(null, new List<Staff>());
        
        var headChefExtentField = typeof(Staff).GetField("_headChefExtent", 
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
        headChefExtentField?.SetValue(null, new List<Staff>());
    ...
    {
        var headChef = new Staff(5,"Ibrahim", "Yesil", 8000m, "Kitchen", StaffType.HeadChef);
    ...
    public void SaveAndLoad()
    {
        new Staff(6,"Arda", "Seydol", 9000m, "Kitchen", StaffType.HeadChef);
...
public class WaiterTests
{
    ...
    public void Setup()
    {
        var extentField = typeof(Staff).GetField("_waiterExtent");
        extentField?.SetValue(null, new List<Staff>());
    ...
    {
        Assert.Throws<ArgumentException>(() => new Staff(1,"Rachel", "Green", 2500m, "Front", StaffType.Waiter));
    }
