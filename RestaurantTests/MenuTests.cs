...
public class MenuTests
{
    ...
    {
        var menu = new Menu.Menu(0, "Lunch Menu", "v1.0", true, null);
    ...
    public void Menu_SaveAndLoadExtent_RestoresMenus()
    {
        ...
        var m1 = new Menu.Menu(0,"Lunch Menu", "v1.0", true, null);
        var m2 = new Menu.Menu(1,"Dinner Menu", "v2.0", false, null);
    ...
    {
        var ft = new FullTime(1,"Derya", "Ogus", 5000m, "Cashier", Shift.Morning, StaffType.Cashier);
